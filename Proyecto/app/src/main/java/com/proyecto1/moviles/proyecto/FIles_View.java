...
public class Files_View extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            files = new GetSharedFilesService().execute(idUser.toString(), "2").get();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            try {
                ...
                new PostUploadFileService().execute("1", idUser.toString(), finalFile.getAbsolutePath()).get();
    ...
    public void download(int id, String name) {
        ...
        Uri Download_Uri = Uri.parse("http://192.168.0.13:8191/rest/files/1");
